...
<div class="container mt-5">
    <div class="flex items-center mb-4">
        ...
        <h1 class="text-xl font-extrabold text-gray-900 ml-2">Tambah Karyawan</h1>
    </div>
    ...
    <form action="{{ route('employee.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" id="name" name="name" required placeholder="Masukkan nama karyawan" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50">
        </div>

        <div>
            <label for="no_telp" class="block text-sm font-medium text-gray-700">No Telepon</label>
            <input type="text" id="no_telp" name="no_telp" required placeholder="Masukkan nomor telepon" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50">
        </div>

        <div>
            <label for="address" class="block text-sm font-medium text-gray-700">Alamat</label>
            <textarea id="address" name="address" required placeholder="Masukkan alamat karyawan" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50"></textarea>
        </div>
