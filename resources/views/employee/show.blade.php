...
<div class="container mt-5">
    <div class="flex items-center mb-4">
        ...
        <h1 class="text-xl font-extrabold text-gray-900 ml-2">Detail Karyawan</h1>
    </div>
    ...
    <div class="bg-white p-4 rounded-md shadow">
        ...
        <div class="mt-4">
            <a href="{{ route('employee.index') }}" class="bg-yellow-500 text-white px-4 py-2 rounded">Kembali</a>
        </div>
    </div>
</div>
@endsection
