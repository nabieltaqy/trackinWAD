...
@section('content')
    <div class="flex items-center mb-4">
        ...
        <h1 class="text-xl font-extrabold text-gray-900 ml-2">Shift</h1>
    </div>
                ...
                @foreach($shifts as $shift)
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b">
                            <a href="{{ route('shift.show', $shift->id) }}" class="text-blue-500">Lihat</a>
                            <a href="{{ route('shift.edit', $shift->id) }}" class="text-yellow-500">Edit</a>
